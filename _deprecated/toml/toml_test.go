...
import (
	...
	"github.com/bloom42/stdx-go/toml"
	"github.com/bloom42/stdx-go/toml/internal/tag"
	tomltest "github.com/bloom42/stdx-go/toml/internal/toml-test"
)
	...
	run := func(t *testing.T, enc bool) {
		r := tomltest.Runner{
			...
			SkipTests: []string{
				...
				// https://github.com/bloom42/stdx-go/toml/issues/320
