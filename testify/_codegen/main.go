...
var (
	pkg       = flag.String("assert-path", "github.com/bloom42/stdx-go/testify/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/bloom42/stdx-go/testify/_codegen; DO NOT EDIT.
